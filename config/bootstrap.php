...
Plugin::load('HiddenField', ['routes' => true, 'autoload' => true]);
Plugin::load('Statistic', ['routes' => true, 'autoload' => true]);
Plugin::load('Faq', ['routes' => true, 'autoload' => true]);
Plugin::load('MonTemplateReports', ['routes' => true, 'autoload' => true]);
Plugin::load('MonStatisticReports', ['routes' => true, 'autoload' => true]);
Plugin::load('MonGeneratedStatisticReports', ['routes' => true, 'autoload' => true]);
Plugin::load('ApiLogs', ['routes' => true, 'autoload' => true]);
...
Plugin::load('MonAPI', ['routes' => true, 'autoload' => true]);
Plugin::load('MonFields', ['routes' => true, 'autoload' => true]);
