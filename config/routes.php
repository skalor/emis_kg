...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('/ResetPasswordByPhone', ['plugin' => 'User', 'controller' => 'Users', 'action' => 'resetPasswordByPhone']);
    $routes->connect('/Help', ['plugin' => 'User', 'controller' => 'Users', 'action' => 'help']);
    $routes->connect('/Contact', ['plugin' => 'User', 'controller' => 'Users', 'action' => 'contact']);
    $routes->connect('/CertCheck', ['plugin' => 'User', 'controller' => 'Users', 'action' => 'certcheck']);
    $routes->connect('/CertCheck/:qr',
        ['plugin' => 'User', 'controller' => 'Users', 'action' => 'certcheck'],
        ['qr'=>'[A-Za-z\d]{5}', 'pass'=>['qr']
    ]);
    $routes->connect('/CertCheck/:qr/:task',
        ['plugin' => 'User', 'controller' => 'Users', 'action' => 'certcheck'],
        ['qr'=>'[A-Za-z\d]{5}', 'task'=>'[A-Za-z_]+', 'pass'=>['qr', 'task']
    ]);

    // Standardised login route
    $routes->connect('/Login', ['plugin' => 'User', 'controller' => 'Users', 'action' => 'login']);
    $routes->connect('/staff/create', ['controller' => 'StaffCreator', 'action' => 'create']);
    //$routes->connect('/grade/create', ['controller' => 'GradeCreator', 'action' => 'create']);
    $routes->connect('/education/create', ['controller' => 'EducationCreator', 'action' => 'create']);
    $routes->connect('/nation/create', ['controller' => 'NationCreator', 'action' => 'create']);
    $routes->connect('/coordinate/create', ['controller' => 'CoordinateCreator', 'action' => 'create']);
    $routes->connect('/coordinate/internet', ['controller' => 'CoordinateCreator', 'action' => 'internet']);


    
    $routes->connect('/dumper/dump', ['controller' => 'DataDump', 'action' => 'dump']);
    $routes->connect('/dumper/export', ['controller' => 'DataDump', 'action' => 'export']);
