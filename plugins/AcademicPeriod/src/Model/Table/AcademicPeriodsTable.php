...
class AcademicPeriodsTable extends AppTable
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('Previous', ['className' => 'AcademicPeriod.AcademicPeriods', 'foreignKey' => 'previous_academic_period_id']);
    ...
    public function beforeAction(Event $event)
    {
        ...
        $this->fields['previous_academic_period_id']['type'] = 'select';
