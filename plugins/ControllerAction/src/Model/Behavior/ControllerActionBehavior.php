...
class ControllerActionBehavior extends Behavior
{
    ...
    protected $_defaultConfig = [
        'actions' => [
            ...
            'downloadHash' => ['show' => false, 'name' => 'file_name_hash', 'content' => 'file_content_hash']
        ],
        'fields' => [
    ...
    // MonPib
    protected $images = [
        'logo_name' => ['index' => false, 'add' => false, 'edit' => false, 'delete' => false],
        'logo_content' => false,
        'photo_name' => false,
        'photo_content' => false
    ];//*/
    ...
    private function initializeFields()
    {
        ...
        // MonPib
        /*foreach($this->images as $field => $visible) {
            if (array_key_exists($field, $fields)) {
                if (is_array($visible)) {
