										...
										?>
											<th>
												<div>
													...
													?>
													<button type="button" class="btn d btn-xs btn-reset" onclick="jsTable.doRemoveColumn(this);"><i class="fa fa-close"></i></button>
												</div>
											</th>
										<?php
												$columnOrder++;
										...
										?>
											<tr>
												<td>
													...
													?>
													<button type="button" class="btn btn-xs gfg btn-reset" onclick="jsTable.doRemove(this);"><i class="fa fa-close"></i></button>
												</td>
												<?php
										...
										?>
											<th>
												<div>
													...
													?>
													<?php if ($data->editable) : ?>
														<button type="button" class="btn sd btn-xs btn-reset" onclick="jsTable.doRemoveColumn(this);"><i class="fa fa-close"></i></button>
													<?php endif; ?>
												</div>
											</th>
										<?php
