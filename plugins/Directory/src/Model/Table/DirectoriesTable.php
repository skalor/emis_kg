...
class DirectoriesTable extends ControllerActionTable
{
    ...
    public function initialize(array $config)
    {
        ...
        $advancedSearchFieldOrder = [
            'user_type', 'last_name', 'first_name', 'middle_name',
            'openemis_no', 'pin', 'gender_id', 'contact_number', 'birthplace_area_id', 'address_area_id', 'position',
    ...
    public function beforeAction(Event $event, ArrayObject $extra)
    {
        if ($this->action == 'add') {
            ...
            $securityUserId = ($encodedParam) ? $securityUserId = $this->ControllerAction->paramsDecode($encodedParam)['id'] : $session->read('Directory.Directories.id');
            if($securityUserId){
        ...
        $this->field('change_surname', ['visible' => false]);
        ...
        $this->field('nationality_user_id', ['visible' => false]);
    ...
    public function addAfterAction(Event $event, Entity $entity, ArrayObject $extra)
    {
        ...
        $this->setFieldOrder([
                ...
                'information_section', 'user_type', 'openemis_no', 'first_name', 'middle_name',
                'last_name', 'gender_id', 'date_of_birth', 'nationality_id',
    ...
    public function indexBeforeAction(Event $event, ArrayObject $extra)
    {
        ...
        $toolbarButtons['advance_search'] = [
            ...
            'url' => '#',
            'label' => '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" clip-rule="evenodd" d="M8.33341 15C4.65152 15 1.66675 12.0152 1.66675 8.33329C1.66675 4.65139 4.65152 1.66663 8.33341 1.66663C12.0153 1.66663 15.0001 4.65139 15.0001 8.33329C15.0001 9.87389 14.4775 11.2924 13.6 12.4213L18.0893 16.9107L16.9108 18.0892L12.4214 13.5998C11.2925 14.4774 9.87401 15 8.33341 15ZM13.3334 8.33329C13.3334 11.0947 11.0948 13.3333 8.33341 13.3333C5.57199 13.3333 3.33341 11.0947 3.33341 8.33329C3.33341 5.57187 5.57199 3.33329 8.33341 3.33329C11.0948 3.33329 13.3334 5.57187 13.3334 8.33329Z" fill="#293845"/> </svg>',
        ];
    }
    ...
    public function editAfterAction(Event $event, Entity $entity, ArrayObject $extra)
    {
        ...
        if ($entity->is_student) {
            ...
            $this->fields['gender_id']['attr']['value'] = $entity->has('gender') ? __($entity->gender->name) : '';
        ...
        if (!empty($entity->main_nationality)) {
            $this->fields['nationality_id']['attr']['value'] = __($entity->main_nationality->name);
        }

        $this->fields['identity_type_id']['type'] = 'readonly';
        if (!empty($entity->main_identity_type)) {
            $this->fields['identity_type_id']['attr']['value'] = __($entity->main_identity_type->name);
        }
