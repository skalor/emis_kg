...
class EducationsController extends AppController
{
    ...
    public function beforeFilter(Event $event)
    {
        ...
        $setupTab = 'Stages';
        if (in_array($selectedAction, ['Stages', 'Subjects', 'Certifications', 'ProgrammeOrientations', 'FieldOfStudies', 'Specialization', 'FormOfTraining'])) {
    ...
    public function Specialization() 	{ $this->ControllerAction->process(['alias' => __FUNCTION__, 'className' => 'Education.EducationSpecialization']); }
    public function FormOfTraining() 	{ $this->ControllerAction->process(['alias' => __FUNCTION__, 'className' => 'Education.EducationFormOfTraining']); }
    ...
    public function MinimumLevel()            { $this->ControllerAction->process(['alias' => __FUNCTION__, 'className' => 'Education.EducationMinimumLevel']); }
}
