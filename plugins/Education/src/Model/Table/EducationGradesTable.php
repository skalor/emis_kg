...
class EducationGradesTable extends ControllerActionTable
{
    ...
    private $_fieldOrder = ['name', 'code', 'education_stage_id', 'admission_age', 'education_programme_id', 'graduation_course', 'visible'];
    ...
    */
    ...
    {
        $this->fields['graduation_course']['type'] = 'select';
        $this->fields['graduation_course']['options'] = $this->getSelectOptions('general.yesno');
