...
class EducationSubjectsTable extends ControllerActionTable
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('EducationSubjectsProfile', ['className' => 'Education.EducationSubjectsProfile', 'foreignKey' => 'education_subjects_profile_id']);
    ...
    {
        $this->field('field_of_studies', ['after' => 'visible', 'entity' => $entity, 'type' => 'custom_field_of_studies']);
        $this->field('education_subjects_profile_id', ['after' => 'code', 'type' => 'select']);
    }
