<?php if (!empty($systemOptions) || !empty($levelOptions) || !empty($cycleOptions) || !empty($programmeOptions) || !empty($gradeOptions) || !empty($setupOptions) || !empty($minimumLevel)) : ?>
    <div class="toolbar-responsive panel-toolbar">
        <div class="toolbar-wrapper">
            ...
            if (!empty($minimumLevel)) {
                ...
                echo $this->Form->input('minimum_levels', array(
                    'class' => 'form-control',
                    'label' => false,
                    'options' => $minimumLevel,
                    'default' => $selectedMinimumLevel,
                    'url' => $baseUrl,
                    'data-named-key' => 'minimum_level',
                    'data-named-group' => 'level,cycle'
                ));
            }
            ?>
        </div>
