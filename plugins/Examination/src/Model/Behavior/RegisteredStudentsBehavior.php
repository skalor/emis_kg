...
class RegisteredStudentsBehavior extends Behavior {
    ...
    public function unregister(Event $event, ArrayObject $extra) {
        ...
        $toolbarButtonsArray['back']['label'] = '<i class="fa kd-back r"></i>';
