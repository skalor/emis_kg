...
class ExaminationCentresTable extends ControllerActionTable {
    ...
    public function indexBeforeAction(Event $event, ArrayObject $extra)
    {
        ...
        $linkExamButton['label'] = '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"> <g id="link_24px"> <path id="icon/content/link_24px" fill-rule="evenodd" clip-rule="evenodd" d="M9.16699 12.5H5.83366C4.45866 12.5 3.33366 11.375 3.33366 9.99998C3.33366 8.62498 4.45866 7.49998 5.83366 7.49998H9.16699V5.83331H5.83366C3.53366 5.83331 1.66699 7.69998 1.66699 9.99998C1.66699 12.3 3.53366 14.1666 5.83366 14.1666H9.16699V12.5ZM14.167 5.83331H10.8337V7.49998H14.167C15.542 7.49998 16.667 8.62498 16.667 9.99998C16.667 11.375 15.542 12.5 14.167 12.5H10.8337V14.1666H14.167C16.467 14.1666 18.3337 12.3 18.3337 9.99998C18.3337 7.69998 16.467 5.83331 14.167 5.83331ZM13.3337 9.16665H6.66699V10.8333H13.3337V9.16665Z" fill="#293845"/> </g> </svg>';
