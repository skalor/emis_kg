...
class FieldOptionComponent extends Component
{
    ...
    // Institution
        ...
        'OperatingMode' => ['className' => 'Institution.OperatingMode', 'parent' => 'Institution'],
        'SchoolType' => ['className' => 'Institution.SchoolType', 'parent' => 'Institution'],
        'InstitutionView' => ['className' => 'Institution.InstitutionView', 'parent' => 'Institution'],
        ...
        // MonLicensing
        'MonLicensingIssuingAuthority' => ['className' => 'Institution.MonLicensingIssuingAuthority', 'parent' => 'Institution'],
        'MonLicensingType' => ['className' => 'Institution.MonLicensingType', 'parent' => 'Institution'],
        'TypesOfFounders' => ['className' => 'FieldOption.TypesOfFounders', 'parent' => 'Institution'],
        'DooAppointment' => ['className' => 'FieldOption.DooAppointment', 'parent' => 'Institution'],
        'TypesOfPractice' => ['className' => 'FieldOption.TypesOfPractice', 'parent' => 'Institution'],
        'NationalitiesUsers' => ['className' => 'FieldOption.NationalitiesUsers', 'parent' => 'Institution'],
        'FormOfStudy' => ['className' => 'FieldOption.FormOfStudy', 'parent' => 'Institution'],
        'DurationOfWork' => ['className' => 'FieldOption.DurationOfWork', 'parent' => 'Institution'],
        'InstitutionPeriod' => ['className' => 'Institution.InstitutionPeriod', 'parent' => 'Institution'],
        'DocumentStatus' => ['className' => 'Institution.DocumentStatus', 'parent' => 'Institution'],
        'DocumentTypes' => ['className' => 'Institution.DocumentTypes', 'parent' => 'Institution'],
        'Importance' => ['className' => 'Institution.Importance', 'parent' => 'Institution'],
        'Circulating' => ['className' => 'Institution.Circulating', 'parent' => 'Institution'],
    ...
    // Student
        ...
        'InstitutionReasonForTransfer' => ['className' => 'Institution.InstitutionReasonForTransfer', 'parent' => 'Student'],
        ...
        'FormOfPayment' => ['className' => 'Institution.FormOfPayment', 'parent' => 'Student'],
    // Staff
        ...
        'ReasonForDismissal' => ['className' => 'Institution.ReasonForDismissal', 'parent' => 'Staff'],
        ...
        'InstitutionReasonForEntrance' => ['className' => 'Institution.InstitutionReasonForEntrance', 'parent' => 'Finance'],
        'InstitutionReasonForExpenditure' => ['className' => 'Institution.InstitutionReasonForExpenditure', 'parent' => 'Finance'],
    ...
    // Others
        ...
        'EducationSubjectsProfile' => ['className' => 'Education.EducationSubjectsProfile', 'parent' => 'Others'],
        'InstitutionClassesView' => ['className' => 'Institution.InstitutionClassesView', 'parent' => 'Others'],
        'CalendarPeriod' => ['className' => 'FieldOption.CalendarPeriod', 'parent' => 'Others'],
        'FixedAssetsType' => ['className' => 'Institution.FixedAssetsType', 'parent' => 'Infrastructure'],
    ...
    // Infrastructure
        ...
        // MonMtb
        'MonUtilityInternetProvider' => ['className' => 'Institution.MonUtilityInternetProvider', 'parent' => 'Infrastructure'],
    ...
    // Health
        ...
        'DisabilityGroups' => ['className' => 'Health.DisabilityGroups', 'parent' => 'Health'],
    ...
    // Special Needs
        ...
        'SpecialNeedsUserAllowanceTypes' => ['className' => 'SpecialNeeds.SpecialNeedsUserAllowanceTypes', 'parent' => 'Special Needs'],

    // MonTemplateTypes
        'MonTemplateTypes' => ['className' => 'MonTemplateReports.MonTemplateTypes', 'parent' => 'MonTemplateReports'],
    ];
