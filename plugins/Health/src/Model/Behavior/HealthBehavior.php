...
class HealthBehavior extends Behavior
{
    ...
    public function beforeAction(Event $event)
    {
        ...
        if ($controller->AccessControl->check([$name, 'HealthPeopleDisabilities', 'index'])) {
            $tabElements['PeopleDisabilities'] = [
                'url' => ['plugin' => $plugin, 'controller' => $name, 'action' => 'HealthPeopleDisabilities'],
                'text' => __('PeopleDisabilities')
            ];
        }
