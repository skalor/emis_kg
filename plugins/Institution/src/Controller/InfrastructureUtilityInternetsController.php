...
class InfrastructureUtilityInternetsController extends PageController
{
    ...
    public function beforeFilter(Event $event)
    {
        ...
        // MonMTB
        $page->get('internet_availability')->setControlType('select')->setOptions([__('yes'), __('no')]);
        $page->get('internet_provider_id')->setControlType('select');
        $page->move('internet_availability')->after('academic_period_id');
        $page->move('internet_provider_id')->after('internet_availability');
    }
    ...
    public function index()
    {
        ...
        // set field
        $page->exclude(['internet_availability', 'comment', 'academic_period_id', 'institution_id']);
    ...
    public function view($id)
    {
        ...
        // set field
        $page->exclude(['internet_availability']);
    ...
    private function addEditInternet()
    {
        ...
        // set availability in hidden
        $page->get('internet_availability')
