...
class InstitutionContactPersonsController extends PageController
{
    ...
    public function beforeFilter(Event $event)
    {
        ...
        $page->exclude(['designation']);

        $positions = TableRegistry::get('Institution.StaffPositionTitles')->find('list')->toArray();
        natcasesort($positions);
        $page->get('position_id')->setControlType('select')->setOptions($positions);
        $page->move('position_id')->after('telephone');
