        ...
        $process = function ($model, $entity) use ($requestData, $extra) {
            ...
            if (!empty($commonData['education_grade'])) {
                foreach ($requestData['MultiClasses'] as $key => $row) {
                    ...
                    $requestData['MultiClasses'][$key]['language_id'] = $commonData['language_id'];
                    $requestData['MultiClasses'][$key]['institution_classes_view_id'] = $commonData['institution_classes_view_id'];
