...
class CourseCatalogueTable extends ControllerActionTable
{
    ...
    public function indexBeforeAction(Event $event, ArrayObject $extra)
    {
        ...
        $backBtn['type'] = 'button';
        $backBtn['label'] = '<i class="fa kd-back rt"></i>';
        $backBtn['attr'] = [
            ...
            if (count($trainingSessions) == 0) {
                ...
                foreach ($trainingSessions as $trainingSession) {
                    ...
                    if (empty($existingApplication)) {
                        ...
                        $rowData[] = "<button aria-expanded='true' onclick='location.href=\"$applyUrl\"' type='button' class='btn btn-dropdown action-toggle btn-single-action'><i class='zg fa kd-add'></i>&nbsp;<span>".__('Apply')."</span></button>";
                    } else {
