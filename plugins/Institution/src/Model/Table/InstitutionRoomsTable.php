...
class InstitutionRoomsTable extends ControllerActionTable
{
    ...
    {
        $this->setFieldOrder([
            'change_type', 'academic_period_id', 'institution_id', 'code', 'name', 'area', 'room_type_id', 'room_status_id', 'start_date', 'start_year', 'end_date', 'end_year', 'infrastructure_condition_id', 'previous_institution_room_id', 'new_room_type', 'new_start_date'
        ]);
