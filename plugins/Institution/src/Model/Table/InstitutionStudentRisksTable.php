...
class InstitutionStudentRisksTable extends ControllerActionTable
{
    ...
    public function indexBeforeAction(Event $event, ArrayObject $extra)
    {
        ...
        $toolbarButtonsArray['back']['label'] = '<svg class="backSvg" width="23" height="24" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M23 10.4999H5.50563L13.5412 2.11501L11.5 0L0 12L11.5 24L13.5268 21.8849L5.50563 13.4999H23V10.4999Z" fill="#004A51"></path> </svg>';
