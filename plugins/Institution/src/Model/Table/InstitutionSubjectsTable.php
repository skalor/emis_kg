...
class InstitutionSubjectsTable extends ControllerActionTable
{
    ...
    public function beforeAction(Event $event, ArrayObject $extra)
    {
        ...
        $this->field('advanced_study', ['type' => 'select','options' => $this->getSelectOptions('general.yesno'), 'visible' => ['index'=>true, 'view'=>true, 'edit'=>true]]);
    ...
    ******************************************************************************************************************/
    public function viewBeforeAction(Event $event, ArrayObject $extra)
    {
        ...
        $this->setFieldOrder([
            'academic_period_id', 'class_name', 'education_grade_id', 'name', 'advanced_study',  'education_subject_code', 'education_subject_id',
    ...
    ******************************************************************************************************************/
    public function addBeforeAction(Event $event, ArrayObject $extra)
    {
        ...
        $this->fields['advanced_study']['visible'] = false;
            ...
            foreach ($data['MultiSubjects'] as $key => $row) {
                if (isset($row['education_subject_id']) && isset($row['subject_staff'])) {
                    ...
                    $subjects[$key] = [
                        'key' => $key,
                        'name' => $row['name'],
                        'advanced_study' => $row['advanced_study'],
        ...
        if ($listOnly) {
            ...
            foreach ($classSubjects as $key => $classSubject) {
                $subjectList[$classSubject->institution_subject->education_subject->id] = [
                    'advanced_study' => $classSubject->institution_subject->advanced_study,
                    'id' => $classSubject->institution_subject->id,
