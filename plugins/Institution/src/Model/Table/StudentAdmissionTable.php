...
class StudentAdmissionTable extends ControllerActionTable
{
    ...
    public function addInstitutionStudent(Entity $entity)
    {
        ...
        $incomingStudent = [
            ...
            'institution_reason_for_transfer_id' => $entity->institution_reason_for_transfer_id,
