...
<div class="alert {{class}} hide" ng-hide="message == null">
...
<div class="wizard" data-initialize="wizard" id="wizard">
    ...
    <div class="actions top">
        ...
        <button
            type="button" class="margin-right-10 btn btn-default" ng-click="InstitutionStudentController.onExternalSearchClick()"
        ...
        <button
            ...
            ng-disabled="!InstitutionStudentController.selectedStudent"
            type="button" class="margin-right-10 btn btn-default"><?= __('Add Student') ?>
        </button>
        <button
            type="button" class="margin-right-10 btn btn-default"
        ...
        <button
            type="button" class="margin-right-10 btn btn-default btn-next"
            ng-show="(InstitutionStudentController.step=='create_user' || InstitutionStudentController.step=='transfer_student')"
            data-last="<?= __('Save') ?>">
            <?= __('Next') ?>
        </button>
        <button ng-click="InstitutionStudentController.onCloseStudentAdd();" type="button" class="btn btn-danger"><i class="fa fa-close"></i></button>
    </div>
    <div class="step-content">
        <div class="step-pane sample-pane active" data-step="1" data-name="internalSearch">
            <div class="dropdown-filter">
                ...
                <div class="text">
                    ...
                    <input ng-model="InstitutionStudentController.internalFilterOpenemisNo" ng-keyup="$event.keyCode == 13 ? InstitutionStudentController.reloadInternalDatasource(true) : null" type="text" maxlength="150">
                </div>
                <div class="text">
                    <label><?= __('First Name') ?></label>
                    <input ng-model="InstitutionStudentController.internalFilterFirstName" ng-keyup="$event.keyCode == 13 ? InstitutionStudentController.reloadInternalDatasource(true) : null" type="text" maxlength="150">
                </div>
                <div class="text">
                    <label><?= __('Last Name') ?></label>
                    <input ng-model="InstitutionStudentController.internalFilterLastName" ng-keyup="$event.keyCode == 13 ? InstitutionStudentController.reloadInternalDatasource(true) : null" type="text" maxlength="150">
                </div>
                <div class="text">
                    <label><?= __('Identity Number') ?></label>
                    <input ng-model="InstitutionStudentController.internalFilterIdentityNumber" ng-keyup="$event.keyCode == 13 ? InstitutionStudentController.reloadInternalDatasource(true) : null" type="text" maxlength="150">
                </div>
                <div class="text">
                    <label><?= __('Pin') ?></label>
                    <input ng-model="InstitutionStudentController.internalFilterPin" ng-keyup="$event.keyCode == 13 ? InstitutionStudentController.reloadInternalDatasource(true) : null" type="text" id="" maxlength="150">
                </div>
        ...
        <div class="step-pane sample-pane active" data-step="2" data-name="externalSearch">
            <div class="dropdown-filter">
                ...
                <div class="text">
                    <label><?= __('First Name') ?></label>
                    <input ng-model="InstitutionStudentController.internalFilterFirstName" ng-disabled="true" type="text" maxlength="150">
                </div>
                <div class="text">
                    <label><?= __('Last Name') ?></label>
                    <input ng-model="InstitutionStudentController.internalFilterLastName" ng-disabled="true" type="text" maxlength="150">
                </div>
                <div class="text">
                    <label><?= __('Identity Number') ?></label>
                    <input ng-model="InstitutionStudentController.internalFilterIdentityNumber" ng-disabled="true" type="text" maxlength="150">
                </div>
                <div class="text">
                    <label><?= __('Pin') ?></label>
                    <input ng-model="InstitutionStudentController.internalFilterPin" ng-disabled="true" type="text" id="" maxlength="150">
                </div>
                <div class="text">
                    <label for="Students_date_of_birth"><?= __('Date Of Birth') ?></label>
        ...
        <div class="step-pane sample-pane" data-step="3" data-name="createUser">
            <form class=" ng-pristine ng-valid" accept-charset="utf-8" method="post">
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3">
                    <label class="control-label"><?= __('OpenEMIS ID') ?></label>
                    <input class="form-control form_control" ng-model="InstitutionStudentController.selectedStudentData.openemis_no" type="string" ng-disabled="true" required>
                ...
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3">
                    <label class="control-label"><?= __('Pin') ?></label>
                    <input class="form-control form_control" ng-model="InstitutionStudentController.selectedStudentData.pin" ng-change="InstitutionStudentController.setStudentName()" type="string" ng-init="InstitutionStudentController.selectedStudentData.pin='';">
                    <div ng-if="InstitutionStudentController.postResponse.error.pin" class="error-message">
                        <p ng-repeat="error in InstitutionStudentController.postResponse.error.pin">{{ error }}</p>
                    </div>
                </div>
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3 required">
                    <label class="control-label"><?= __('Last Name') ?></label>
                    <input class="form-control form_control" ng-model="InstitutionStudentController.selectedStudentData.last_name" ng-change="InstitutionStudentController.setStudentName()" type="string" ng-init="InstitutionStudentController.selectedStudentData.last_name='';" required>
                ...
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3 required">
                    ...
                    <input class="form-control form_control" ng-model="InstitutionStudentController.selectedStudentData.first_name" ng-change="InstitutionStudentController.setStudentName()" type="string" ng-init="InstitutionStudentController.selectedStudentData.first_name='';" required>
                ...
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3">
                    ...
                    <input class="form-control form_control" ng-model="InstitutionStudentController.selectedStudentData.middle_name" ng-change="InstitutionStudentController.setStudentName()" type="string" required>
                </div>
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3">
                ...
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3 required">
                    <label class="control-label" for="Student_date_of_birth"><?= __('Date Of Birth') ?></label>
                    <div class="input-group date " id="Student_date_of_birth" style="">
                        <input type="text" class="form-control" name="Student[date_of_birth]" ng-model="InstitutionStudentController.selectedStudentData.date_of_birth" ng-init="InstitutionStudentController.selectedStudentData.date_of_birth='';" required>
                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                    </div>
                ...
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3 required"  ng-show="InstitutionStudentController.StudentNationalities != 2">
                ...
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3"  >
                    <label class="control-label"><?= __('Native Language') ?></label>
                    <div class="input-select-wrapper">
                        <select name="Students[language_id]" id="language-id"
                                ng-options="option.id as option.name for option in InstitutionStudentController.StudentLanguageOptions"
                                ng-model="InstitutionStudentController.Student.language_id"
                                ng-change="InstitutionStudentController.changeLanguage()"
                        >
                            <option value="" >-- <?= __('Select') ?> --</option>
                        </select>
                    </div>
                    <div ng-if="InstitutionStudentController.postResponse.error.language_id" class="error-message">
                        <p ng-repeat="error in InstitutionStudentController.postResponse.error.language_id">{{ error }}</p>
                    </div>
                </div>
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3 required"  ng-show="InstitutionStudentController.StudentIdentities != 2 && InstitutionStudentController.StudentNationalities == 2">
                    <label class="control-label"><?= __('Identity Type') ?></label>
                    <div class="input-select-wrapper">
                ...
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3 required" ng-show="InstitutionStudentController.StudentIdentities != 2">
                    <label class="control-label"><?= __('{{InstitutionStudentController.Student.identity_type_name}}') ?></label>
                    <input class="form-control" ng-model="InstitutionStudentController.selectedStudentData.identity_number" type="string" ng-init="InstitutionStudentController.selectedStudentData.identity_number='';">
                ...
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3 required">
                    ...
                    <input  class="form-control form_control" ng-model="InstitutionStudentController.selectedStudentData.username" type="string" ng-init="InstitutionStudentController.selectedStudentData.username='';">
                ...
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3 required password">
                    <label class="control-label"><?=
                        ...
                        ?></label>
                    <input class="form-control form_control" ng-model="InstitutionStudentController.selectedStudentData.password" type="string" ng-init="InstitutionStudentController.selectedStudentData.password='';">
        ...
        <div class="step-pane sample-pane" data-step="4" data-name="addStudent">
            <form class=" ng-pristine ng-valid" accept-charset="utf-8" method="post" >
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3 required"">
                    <label class="control-label"><?= __('OpenEMIS ID') ?></label>
                    <input class="form-control form_control" ng-model="InstitutionStudentController.selectedStudentData.openemis_no" type="string" ng-disabled="true">
                    <div ng-if="InstitutionStudentController.postResponse.error.openemis_no" class="error-message">
                        <p ng-repeat="error in InstitutionStudentController.postResponse.error.openemis_no">{{ error }}</p>
                    </div>
                </div>
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3" ng-model="InstitutionStudentController.postResponse">
                    <label class="control-label"><?= __('Student') ?></label>
                    <input class="form-control form_control" ng-model="InstitutionStudentController.selectedStudentData.name" type="string" disabled="disabled">
                    <div ng-if="InstitutionStudentController.postResponse.error.first_name" class="error-message">
                        <p ng-repeat="error in InstitutionStudentController.postResponse.error.first_name">{{ error }}</p>
                    </div>
                    <div ng-if="InstitutionStudentController.postResponse.error.last_name" class="error-message">
                ...
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3" ng-show="InstitutionStudentController.StudentNationalities != 2 && StudentController.createNewStudent == true">
                    <label class="control-label"><?= __('Nationality') ?></label>
                    <input class="form-control form_control" ng-model="InstitutionStudentController.Student.nationality_name" type="string" disabled="disabled">
                    <div ng-if="InstitutionStudentController.postResponse.error.nationalities[0].nationality_id" class="error-message">
                        <p ng-repeat="error in InstitutionStudentController.postResponse.error.nationalities[0].nationality_id">{{ error }}</p>
                    </div>
                </div>
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3" ng-show="InstitutionStudentController.StudentIdentities != 2">
                    <label class="control-label"><?= __('Identity Number') ?></label>
                    <input class="form-control form_control" ng-model="InstitutionStudentController.selectedStudentData.identity_number" type="string" disabled="disabled">
                    <div ng-if="InstitutionStudentController.postResponse.error.identities[0].number" class="error-message">
                        <p ng-repeat="error in InstitutionStudentController.postResponse.error.identities[0].number">{{ error }}</p>
                    </div>
                </div>
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3">
                    ...
                    <input class="form-control form_control" ng-model="InstitutionStudentController.selectedStudentData.date_of_birth" type="string" disabled="disabled">
                    <div ng-if="InstitutionStudentController.postResponse.error.date_of_birth" class="error-message">
                        <p ng-repeat="error in InstitutionStudentController.postResponse.error.date_of_birth">{{ error }}</p>
                    </div>
                </div>
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3">
                    <label class="control-label"><?= __('Gender') ?></label>
                    <input class="form-control form_control" ng-model="InstitutionStudentController.selectedStudentData.gender.name" type="string" disabled="disabled">
                    <div ng-if="InstitutionStudentController.postResponse.error.gender_id" class="error-message">
                        <p ng-repeat="error in InstitutionStudentController.postResponse.error.gender_id">{{ error }}</p>
                    </div>
                </div>
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3 required">
                    <label class="control-label"><?= __('Username') ?></label>
                    <input class="form-control form_control" ng-model="InstitutionStudentController.selectedStudentData.username" type="string" disabled="disabled">
                    <div ng-if="InstitutionStudentController.postResponse.error.username" class="error-message">
                        <p ng-repeat="error in InstitutionStudentController.postResponse.error.username">{{ error }}</p>
                    </div>
                </div>

                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3 required" ng-show="!InstitutionStudentController.existingStudent">
                    <label class="control-label"><?= __('Password') ?></label>
                    <input class="form-control form_control" ng-model="InstitutionStudentController.selectedStudentData.password" type="string" disabled="disabled">
                    <div ng-if="InstitutionStudentController.postResponse.error.password" class="error-message">
                        <p ng-repeat="error in InstitutionStudentController.postResponse.error.password">{{ error }}</p>
                    </div>
                </div>
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3 required" ng-model="InstitutionStudentController.postResponse" ng-show="!InstitutionStudentController.existingStudent">
                    <label class="control-label"><?= __('Academic Period') ?></label>
                    <div class="input-select-wrapper">
                        <select name="Students[academic_period_id]" id="students-academic-period-id" class="form-control"
                ...
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3 required" ng-model="InstitutionStudentController.postResponse" ng-show="!InstitutionStudentController.existingStudent">
                    <label class="control-label"><?= __('Education Grade') ?></label>
                    <div class="input-select-wrapper">
                        <select name="Students[education_grade_id]" id="students-education-grade-id" class="form-control"
                ...
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3" ng-show="!InstitutionStudentController.existingStudent">
                    <label class="control-label"><?= __('Class') ?></label>
                    <div class="input-select-wrapper">
                        <select name="Students[class]" id="students-class" class="form-control"
                ...
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3" ng-show="!InstitutionStudentController.existingStudent">
                    <label class="control-label"><?= __('Student Status') ?></label>
                    <input class="form-control form_control" type="string" value="<?= __('Pending Admission') ?>" disabled="disabled">
                </div>
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3" ng-class="InstitutionStudentController.Student.reason_class" >
                    <label><?= __('Institution Reason For Transfer') ?></label>
                    <div class="input-select-wrapper">
                        <select name="Students[institution_reason_for_transfer_id]" id="institution_reason_for_transfer_id"
                                ng-options="option.id as option.name for option in InstitutionStudentController.StudentReasonOptions"
                                ng-model="InstitutionStudentController.Student.reason_id"
                                ng-change="InstitutionStudentController.changeReason()"
                        >
                            <option value="" >-- <?= __('Select') ?> --</option>
                        </select>
                    </div>
                    <div ng-if="InstitutionStudentController.postResponse.error.institution_reason_for_transfer_id" class="error-message">
                        <p ng-repeat="error in InstitutionStudentController.postResponse.error.institution_reason_for_transfer_id">{{ error }}</p>
                    </div>
                </div>
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3 required" ng-show="!InstitutionStudentController.existingStudent">
                    <label class="control-label" for="Students_start_date"><?= __('Start Date') ?></label>
                    <div class="input-group date " id="Students_start_date" style="">
                        <input class="form-control form_control" type="text" class="form-control " name="Students[start_date]" ng-model="InstitutionStudentController.startDate">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                    </div>
                ...
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3 required" ng-show="!InstitutionStudentController.existingStudent">
                    <label class="control-label" for="students-end-date"><?= __('End Date') ?></label>
                    <input class="form-control form_control" ng-model="InstitutionStudentController.endDateFormatted" type="text" disabled="disabled">
                </div>

                <div class="section-header" ng-show="InstitutionStudentController.existingStudent"><?= __('Student Information') ?></div>
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3" ng-show="InstitutionStudentController.existingStudent">
                    <label class="control-label"><?= __('Academic Period') ?></label>
                    <input class="form-control form_control" type="string" ng-model="InstitutionStudentController['selectedStudentData']['institution_students'][0]['academic_period']['name']" disabled="disabled">
                </div>
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3" ng-show="InstitutionStudentController.existingStudent">
                    <label class="control-label"><?= __('Education Grade') ?></label>
                    <input class="form-control form_control" type="string" ng-model="InstitutionStudentController['selectedStudentData']['institution_students'][0]['education_grade']['name']" disabled="disabled">
                </div>
                <div class="form-group  col-sm-6 col-6 col-lg-3 col-md-3" ng-show="InstitutionStudentController.existingStudent">
                    <label class="control-label"><?= __('Student Status') ?></label>
                    <input class="form-control form_control" type="string" value="<?= __('Enrolled') ?>" disabled="disabled">
                </div>
...
<script>
    $(function () {
        var datepicker0 = $('#Students_start_date').datepicker({"format":"dd-mm-yyyy","todayBtn":"linked","orientation":"auto","autoclose":true,'language':'<?= $htmlLang ?>'});
        var datepicker1 = $('#Students_date_of_birth').datepicker({"format":"dd-mm-yyyy","todayBtn":"linked","orientation":"auto","autoclose":true,'language':'<?= $htmlLang ?>'});
        var datepicker2 = $('#Student_date_of_birth').datepicker({"format":"dd-mm-yyyy","todayBtn":"linked","orientation":"auto","autoclose":true,'language':'<?= $htmlLang ?>'});
        var datepicker3 = $('#Students_transfer_start_date').datepicker({"format":"dd-mm-yyyy","todayBtn":"linked","orientation":"auto","autoclose":true,'language':'<?= $htmlLang ?>'});
