    ...
    <div class="step-content">
        <div class="step-pane sample-pane active" data-step="1" data-name="internalSearch">
            <div class="dropdown-filter">
                ...
                <div class="text">
                    <label><?= __('Pin') ?></label>
                    <input ng-model="InstitutionStaffController.internalFilterPin" ng-keyup="$event.keyCode == 13 ? InstitutionStaffController.reloadInternalDatasource(true) : null" type="text" id="" maxlength="150">
                </div>
                <div class="date">
        ...
        <div class="step-pane sample-pane active" data-step="2" data-name="externalSearch">
            <div class="dropdown-filter">
                ...
                <div class="text">
                    <label><?= __('Pin') ?></label>
                    <input ng-model="InstitutionStaffController.internalFilterPin" ng-disabled="true" type="text" id="" maxlength="150">
                </div>
                <div class="text">
                    <label for="Staffs_date_of_birth"><?= __('Date Of Birth') ?></label>
        ...
        <div class="step-pane sample-pane" data-step="3" data-name="createUser">
            <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                ...
                <div class="input string">
                    <label><?= __('Pin') ?></label>
                    <input ng-model="InstitutionStaffController.selectedStaffData.pin" ng-change="InstitutionStaffController.setStaffName()" type="string" ng-init="InstitutionStaffController.selectedStaffData.pin='';">
                    <div ng-if="InstitutionStaffController.postResponse.error.pin" class="error-message">
                        <p ng-repeat="error in InstitutionStaffController.postResponse.error.pin">{{ error }}</p>
                    </div>
                </div>
                ...
                <div class="input string">
                    ...
                    <input ng-model="InstitutionStaffController.selectedStaffData.email" ng-change="InstitutionStaffController.setStaffName()" type="string" ng-init="InstitutionStaffController.selectedStaffData.email='';">
                    <div ng-if="InstitutionStaffController.postResponse.error.email" class="error-message">
                        <p ng-repeat="error in InstitutionStaffController.postResponse.error.email">{{ error }}</p>
                    </div>
                </div>

                <div class="input string">
                    <label><?=
                        __('Mobile Phone') . '&nbsp&nbsp;<i class="fa fa-info-circle fa-lg table-tooltip icon-blue" data-placement="right" data-toggle="tooltip" data-animation="false" data-container="body" title="" data-html="true" data-original-title="' . __('Format: starts with 996') . '"></i>'
                        ?></label>
                    <input ng-model="InstitutionStaffController.selectedStaffData.mobile_phone" ng-change="InstitutionStaffController.setStaffName()" type="string" ng-init="InstitutionStaffController.selectedStaffData.mobile_phone='';">
                    <div ng-if="InstitutionStaffController.postResponse.error.mobile_phone" class="error-message">
                        <p ng-repeat="error in InstitutionStaffController.postResponse.error.mobile_phone">{{ error }}</p>
                    </div>
                </div>
                ...
                <div class="input select" ng-class="InstitutionStaffController.Staff.language_class" >
                    <label><?= __('Native Language') ?></label>
                    <div class="input-select-wrapper">
                        <select name="Staff[language_id]" id="language-id"
                                ng-options="option.id as option.name for option in InstitutionStaffController.StaffLanguageOptions"
                                ng-model="InstitutionStaffController.Staff.language_id"
                                ng-change="InstitutionStaffController.changeLanguage()"
                        >
                            <option value="" >-- <?= __('Select') ?> --</option>
                        </select>
                    </div>
                    <div ng-if="InstitutionStaffController.postResponse.error.language_id" class="error-message">
                        <p ng-repeat="error in InstitutionStaffController.postResponse.error.language_id">{{ error }}</p>
                    </div>
                </div>
...
<script>
$(function () {
var datepicker0 = $('#Staff_start_date').datepicker({"format":"dd-mm-yyyy","todayBtn":"linked","orientation":"auto","autoclose":true,'language':'<?= $htmlLang ?>'});
var datepicker1 = $('#Staff_end_date').datepicker({"format":"dd-mm-yyyy","todayBtn":"linked","orientation":"auto","autoclose":true,'language':'<?= $htmlLang ?>'});
var datepicker2 = $('#Staffs_date_of_birth').datepicker({"format":"dd-mm-yyyy","todayBtn":"linked","orientation":"auto","autoclose":true,'language':'<?= $htmlLang ?>'});
var datepicker3 = $('#Staff_date_of_birth').datepicker({"format":"dd-mm-yyyy","todayBtn":"linked","orientation":"auto","autoclose":true,'language':'<?= $htmlLang ?>'});
