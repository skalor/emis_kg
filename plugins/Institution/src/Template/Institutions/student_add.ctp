...
$this->Html->script('ControllerAction.../plugins/datepicker/locales/bootstrap-datepicker.ru.min', ['block' => true]);
$this->Html->script('ControllerAction.../plugins/datepicker/locales/bootstrap-datepicker.kg.min', ['block' => true]);
?>
    ...
    <div class="step-content">
        ...
        <div class="step-pane sample-pane" data-step="3" data-name="createUser">
            <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                ...
                <div class="input string">
                    <label><?= __('Pin') ?></label>
                    <input ng-model="InstitutionStudentController.selectedStudentData.pin" ng-change="InstitutionStudentController.setStudentName()" type="string" ng-init="InstitutionStudentController.selectedStudentData.pin='';">
                ...
                <div class="input select" ng-class="InstitutionStudentController.Student.language_class" >
                    <label><?= __('Native Language') ?></label>
                    <div class="input-select-wrapper">
                ...
                <div class="input select">
                    <label><?= __('Sop') ?></label>
                    <div class="input-select-wrapper">
                        <select name="Students[sop]" id="students-sop"
                                ng-options="item.id as item.name for item in [{'id':1,'name':'<?= __('Yes')?>'},{'id':0,'name':'<?= __('No')?>'}]"
                                ng-model="InstitutionStudentController.Student.sop">
                            <option value="" selected>-- <?= __('Select') ?> --</option>
                        </select>
                    </div>
                </div>
                <div class="input select">
                    <label><?= __('Orphan') ?></label>
                    <div class="input-select-wrapper">
                        <select name="Students[orphan]" id="students-orphan"
                                ng-options="item.id as item.name for item in [{'id':1,'name':'<?= __('Yes')?>'},{'id':0,'name':'<?= __('No')?>'}]"
                                ng-model="InstitutionStudentController.Student.orphan">
                            <option value="" selected>-- <?= __('Select') ?> --</option>
                        </select>
                    </div>
                </div>
        ...
        <div class="step-pane sample-pane" data-step="4" data-name="addStudent">
            <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post" >
                ...
                <div class="input select" ng-class="InstitutionStudentController.Student.reason_class" >
