...
function InstitutionClassStudentsController($scope, $q, $window, $http, UtilsSvc, AlertSvc, AggridLocaleSvc, InstitutionClassStudentsSvc) {
    ...
    Controller.institution_classes_view_id = null;
    Controller.selectedSecondaryTeacher = [];
    Controller.className = '';
    Controller.firstClassName = '';
    ...
    angular.element(document).ready(function () {
        ...
        if (Controller.classId != null) {
            ...
            .then(function(response) {
                ...
                Controller.firstClassName = response.name;
                ...
                Controller.language_id = response.language_id;
                Controller.institution_classes_view_id = response.institution_classes_view_id;
    ...
    function postForm() {
        ...
        postData.language_id = Controller.language_id;
        postData.institution_classes_view_id = Controller.institution_classes_view_id;
