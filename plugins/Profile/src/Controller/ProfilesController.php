...
class ProfilesController extends AppController
{
    ...
    public function SpecialNeedsHostel()       { $this->ControllerAction->process(['alias' => __FUNCTION__, 'className' => 'SpecialNeeds.SpecialNeedsHostel']); }
    public function SpecialNeedsUserAllowance(){$this->ControllerAction->process(['alias' => __FUNCTION__, 'className' => 'SpecialNeeds.SpecialNeedsUserAllowance']);}
    // Special Needs - End
