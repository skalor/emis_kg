...
class UsersTable extends AppTable
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('NationalitiesUsers', ['className' => 'FieldOption.NationalitiesUsers', 'foreignKey' => 'nationality_user_id']);
        $this->belongsTo('FormOfStudy', ['className' => 'FieldOption.NationalitiesUsers', 'foreignKey' => 'form_of_study_id']);
         ...
         * fieldOption tables
         */
        $this->belongsTo('NativeLanguages', ['className' => 'Languages', 'foreignKey' => 'language_id']);
    ...
    public function beforeAction(Event $event)
    {
        ...
        $this->fields['is_acp']['visible'] = false;
        $this->fields['photo_content']['visible'] = false;
        $this->fields['address']['visible'] = false;
        $this->fields['postal_code']['visible'] = false;
        $this->fields['old_surname']['visible'] = false;
        $this->fields['change_surname']['visible'] = false;
        ...
        $this->fields['nationality_user_id']['visible'] = false;
        $this->fields['home_education']['visible'] = false;
        $this->fields['sop']['visible'] = false;
        $this->fields['orphan']['visible'] = false;
        $this->fields['form_of_payment_id']['visible'] = false;
        $this->fields['foreigner']['visible'] = false;
        $this->fields['responsible_gender_social_coordinator']['visible'] = false;
        $this->fields['teacher_education']['visible'] = false;
        $this->fields['teacher_special_education']['visible'] = false;
        $this->fields['certificate_inclusive_education']['visible'] = false;
        $this->fields['form_of_study_id']['visible'] = false;

        if ($this->action == 'edit') {
            $this->fields['last_login']['visible'] = false;
        }

        $this->ControllerAction->field('language_id', [
            'type' => 'select',
            'visible' => ['index' => false, 'view' => true, 'edit' => true],
            'options'=> $this->NativeLanguages->find('list')->all()->toArray(),
        ...
        $this->ControllerAction->setFieldOrder([
            'openemis_no',  'last_name', 'first_name', 'middle_name', 'gender_id', 'date_of_birth', 'status', 'username', 'password'
        ]);
    }
