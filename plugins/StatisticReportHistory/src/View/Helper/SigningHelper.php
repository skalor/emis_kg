<?php
namespace StatisticReportHistory\View\Helper;
        ...
        foreach ($data as $entity) {
            ...
            foreach ($fields as $field => $attr) {
                ...
                if ($field === 'is_signed') {
                    ...
                    if ($entity->$field) {
                        array_unshift($row, '<input type="checkbox" class="signCheck" name="checked_ids['. $entity->id .']" style="opacity:1" disabled checked>');
                    } else {
                        array_unshift($row, '<input type="checkbox" class="signCheck" name="checked_ids['. $entity->id .']" style="opacity:1">');
                    }
