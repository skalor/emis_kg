...
class StudentsController extends AppController
{
    ...
    {
        $this->ControllerAction->process(['alias' => __FUNCTION__, 'className' => 'Student.StudentPractice']);
    }
    public function StudentEducation()
    {
        $this->ControllerAction->process(['alias' => __FUNCTION__, 'className' => 'Student.StudentEducation']);
    }
    ...
    public function HealthPeopleDisabilities()
    {
        $this->ControllerAction->process(['alias' => __FUNCTION__, 'className' => 'Health.PeopleDisabilities']);
    }
    ...
    public function SpecialNeedsHostel()
    {
        $this->ControllerAction->process(['alias' => __FUNCTION__, 'className' => 'SpecialNeeds.SpecialNeedsHostel']);
    }
    public function SpecialNeedsUserAllowance()
    {
        $this->ControllerAction->process(['alias' => __FUNCTION__, 'className' => 'SpecialNeeds.SpecialNeedsUserAllowance']);
    }
    // Special Needs - End
