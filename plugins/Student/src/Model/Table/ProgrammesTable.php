...
class ProgrammesTable extends ControllerActionTable
{
    ...
    public function onGetReasonForTheOperation(Event $event, Entity $entity)
    {
        ...
        if ($entity->student_status_id == $statuses['CURRENT']) {
            if ($entity->institution_reason_for_transfer_id) {
                $reasonRecord = $institutionReasonForTransfer->get($entity->institution_reason_for_transfer_id);
            }
        } else if ($entity->student_status_id == $statuses['WITHDRAWN']) {
        ...
        } else if ($entity->student_status_id == $statuses['TRANSFERRED']) {
    ...
    public function beforeAction(Event $event, ArrayObject $extra)
    {
        ...
        $this->field('institution_reason_for_transfer_id', ['type' => 'select','after'=>'end_year']);
    }
	...
	public function indexBeforeAction(Event $event, ArrayObject $extra)
	{
		...
		$this->setFieldOrder([
			'academic_period_id', 'institution_id', 'education_grade_id', 'start_date', 'end_date', 'student_status_id','reason_for_the_operation'
		]);
	}
