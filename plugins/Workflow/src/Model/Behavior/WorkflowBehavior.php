    ...
    public function approve(Event $event)
    {
        if ($this->isCAv4()) {
            ...
            if ($jsonActionAttr) {
                ...
                // back button
                $backBtn['type'] = 'button';
                $backBtn['label'] =  '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M22.404 11.1518H7.18848L14.1774 4.16285L12.402 2.4L2.40002 12.402L12.402 22.404L14.1649 20.6411L7.18848 13.6523H22.404V11.1518Z" fill="#004A51"/> </svg>';
                $backBtn['attr'] = [
                    'class' => 'btn btn-xs btn-default',
                    'data-toggle' => 'tooltip',
                    'data-placement' => 'bottom',
                ...
                if (!empty($workflowStep)) {
                    ...
                    if ($canAddButtons) {
                        ...
                        if ($isSuperAdmin || $userId == $assigneeId) {
                            ...
                            $reassignButton['label'] = '<svg width="22" height="24" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M9.06125 7.75499L1.93874 0L0 2.11499L7.10874 9.87L9.06125 7.75499ZM14.4375 0L17.2425 3.05999L0 21.8851L1.93874 24L19.195 5.19L22 8.25V0H14.4375ZM14.8912 14.1149L12.9525 16.23L17.2562 20.9251L14.4375 24H22V15.75L19.195 18.81L14.8912 14.1149Z" fill="#293845"/> </svg>';
                            $reassignButton['url'] = '#';
                        ...
                        foreach ($workflowStep->workflow_actions as $actionKey => $actionObj) {
                            ...
                            if (is_null($actionType)) {
                                ...
                                if ($actionType == 0) { // Approve
                                    ...
                                    $approveButton['label'] = '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" clip-rule="evenodd" d="M21.3334 0H2.66666C1.2 0 0 1.2 0 2.66666V21.3334C0 22.8 1.2 24 2.66666 24H21.3334C22.8 24 24 22.8 24 21.3334V2.66666C24 1.2 22.8 0 21.3334 0ZM21.3334 21.3334H2.66666V2.66666H21.3334V21.3334ZM18.1067 6.10669L19.9867 8.00002L9.31999 18.6667L3.98665 13.3467L5.87999 11.4667L9.31999 14.8933L18.1067 6.10669Z" fill="#009966"/> </svg>';
                                    ...
                                    $rejectButton['label'] = '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" clip-rule="evenodd" d="M2.66666 0H21.3334C22.8 0 24 1.2 24 2.66666V21.3334C24 22.8 22.8 24 21.3334 24H2.66666C1.2 24 0 22.8 0 21.3334V2.66666C0 1.2 1.2 0 2.66666 0ZM21.3334 21.3334V2.66667H2.66666V21.3334H21.3334Z" fill="#C71100"/> <path d="M8.29129 18L12.5 13.7912L16.7087 18L19 15.7088L14.7912 11.5L19 7.29121L16.7087 5L12.5 9.20875L8.29129 5L6 7.29121L10.2087 11.5L6 15.7088L8.29129 18Z" fill="#C71100"/> </svg>';
                                    $rejectButton['url'] = '#';
