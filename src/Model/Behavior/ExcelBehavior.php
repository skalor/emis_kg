...
class ExcelBehavior extends Behavior
{
    ...
    public function beforeAction(Event $event, ArrayObject $extra)
    {
        ...
        if (in_array($action, $this->config('pages'))) {
            ...
            $toolbarButtons['export'] = [
                'type' => 'button',
                'label' => '<svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" clip-rule="evenodd" d="M16.9669 8.95441L10.1596 0.109985L3.1118 8.76391L7.28895 8.82134L8.27641 14.9772L11.4761 15.0212L12.6324 8.89481L16.9669 8.95441Z" fill="#009966"/> <path fill-rule="evenodd" clip-rule="evenodd" d="M17.5428 12.7758V20.2758C17.5428 21.1963 16.7966 21.9425 15.8761 21.9425H4.20945C3.28898 21.9425 2.54279 21.1963 2.54279 20.2758V12.7758H4.20945V20.2758H15.8761V12.7758H17.5428Z" fill="#564242"/> </svg>',
                'attr' => $toolbarAttr,
                'url' => ''
            ];
    ...
    public function onUpdateToolbarButtons(Event $event, ArrayObject $buttons, ArrayObject $toolbarButtons, array $attr, $action, $isFromModel)
    {
        if ($buttons->offsetExists('view')) {
            $export = $buttons['view'];
            $export['type'] = 'button';
            $export['label'] = '<svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" clip-rule="evenodd" d="M16.9669 8.95441L10.1596 0.109985L3.1118 8.76391L7.28895 8.82134L8.27641 14.9772L11.4761 15.0212L12.6324 8.89481L16.9669 8.95441Z" fill="#009966"/> <path fill-rule="evenodd" clip-rule="evenodd" d="M17.5428 12.7758V20.2758C17.5428 21.1963 16.7966 21.9425 15.8761 21.9425H4.20945C3.28898 21.9425 2.54279 21.1963 2.54279 20.2758V12.7758H4.20945V20.2758H15.8761V12.7758H17.5428Z" fill="#564242"/> </svg>';
            $export['attr'] = $attr;
            ...
            $export = $buttons['back'];
            $export['type'] = 'button';
            $export['label'] = '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M18 12L24 12L12 24L-5.24537e-07 12L6 12L6 -7.86805e-07L18 -2.62268e-07L18 12ZM12 19.755L16.755 15L15 15L15 3L8.99997 3L8.99997 15L7.24497 15L12 19.755Z" fill="#009966"/></svg>';
            $export['attr'] = $attr;
            $export['attr']['title'] = __('Export');
