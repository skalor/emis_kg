    ...
    public $messages = [
        ...
        'general' => [
            ...
            'delete' => [
                ...
                'deductionDelete' => 'You cannot delete an entry because the funds for this receipt are already in use.',
        ...
        'Institution' => [
            'Institutions' => [
                ...
                'area_id' => [
                    'configuredAreaAdministrative' => 'Not correct Area'
                ],
                'area_administrative_id' => [
                    'configuredArea' => 'Please select area administrative from %s level.'
                ],
                'area_aimak_id' => [
                    'configuredArea' => 'Please select area aimak from %s level.'
                ],
                'area_aimak_id' => [
                    'configuredAreaAimak' => 'Not correct Aimak'
                ],
                'code' => [
            ...
            'InstitutionClasses' => [
                ...
                'capacity' => [
                    ...
                    'ruleCheckMinStudentsPerClass' => 'The value cannot be less than 0 or 0'
                ],
            ],
        ...
        'User' => [
            ...
            'Contacts' => [
                ...
                'value' => [
                    ...
                    'ruleValidateMobilePhone' => 'Format: starts with 996 and only numeric values',
                    'ruleValidateOtherPhone' => 'Please enter a valid Numeric value',
                ],
                'preferred' => [
