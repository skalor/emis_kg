class StatisticsCountGender
{
  ...
  work()
  {
    ...
    const allNumText = this.html.find("#allNumText")
    const boy_body = this.html.find("#boy__body");
    const boy_header = this.html.find("#boy__header");
    const boy_num = this.html.find("#boy__num");
    const boy_line = this.html.find("#boy__line");
    const boy_nameText = this.html.find("#boy__nameText");
    const allNum = this.html.find("#allNum");
    const girl_body = this.html.find("#girl__body");
    const girl_header = this.html.find("#girl__header");
    const girl_num = this.html.find("#girl__num");
    const girl_line = this.html.find("#girl__line");
    const girl_nameText = this.html.find("#girl__nameText");
    ...
    dateText[0].innerHTML = this.object.xAxis.title.text + " " + this.object.xAxis.categories[this.currentVue];
  ...
  {
    this.html.html( `
      <svg width="406" height="409" viewBox="0 0 416 359" fill="none" xmlns="http://www.w3.org/2000/svg">
      <!-- ================================ boy ========================================= -->
        <g>
        ...
        <mask id="mask03" mask-type="alpha" maskUnits="userSpaceOnUse" x="46" y="132" width="70" height="148">
        ...
        <mask id="mask013" mask-type="alpha" maskUnits="userSpaceOnUse" x="46" y="50" width="70" height="148">
      ...
      <!-- ================================ girl ======================================== -->
        ...
        <mask id="mask13" mask-type="alpha" maskUnits="userSpaceOnUse" x="225" y="133" width="80" height="147">
        ...
        <mask id="mask113" mask-type="alpha" maskUnits="userSpaceOnUse" x="225" y="98" width="80" height="147">
